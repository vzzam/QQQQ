...
# ==========================================
# 📂 قاعدة البيانات الشاملة (تغطي Fat, Slim, Pro)
# ==========================================
PS5_DB = {
    # اليابان وأوروبا وأمريكا (الأجهزة الأولى)
...
# ==========================================
# 🛠️ دالة فلترة الثغرات (إظهار المدعوم فقط)
# ==========================================
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    welcome = "𝐏𝐒𝟓𝐀𝐙 𝐉𝐀𝐈𝐋𝐁𝐑𝐄𝐀𝐊 𝐂𝐇𝐄𝐂𝐊𝐄𝐑 🎮\n\n📥 <b>ارسل السيريال نمبر الموجود أسفل كرتون الجهاز للفحص.</b>"
